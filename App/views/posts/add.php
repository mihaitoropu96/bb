<?php use App\Config\Config;
    ...
    require dirname(__DIR__ ). '/incl/header.php'; ?>
  <a href="<?php echo config::URLROOT; ?>/posts" class="btn btn-light">🔙Back</a>
  <div class="card card-body bg-light mt-5">
    <h2>Add Post</h2>
    <p>Create a post with this form</p>
    <form action="<?php echo config::URLROOT; ?>/posts/add" method="post">
